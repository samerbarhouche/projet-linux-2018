...
int connectServer(char nom[], char machine[], char port[]) 
{
...
printf("Couldn't send name to server \n");
...
if (strlen(message) == strlen(exitChatroom) + 1 && message[0] == '_' && message[1] == 'q' && message[2] == 'u' && message[3] == 'i' && message[4] == 't') 
{
...
printf("Use '_connect <name> <machine> <port>' and connect to server instantly\n");
    
printf("Use '_quit' to close connection \n");
...
connectServer(nom, machine, port);
